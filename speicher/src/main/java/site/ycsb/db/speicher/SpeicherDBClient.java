 ...
 */
public class SpeicherDBClient extends DB {

  static final String PROPERTY_ROCKSDB_DIR = "speicher.dir";
  static final String PROPERTY_ROCKSDB_OPTIONS_FILE = "speicher.optionsfile";
  private static final String COLUMN_FAMILY_NAMES_FILENAME = "CF_NAMES";

  private static final Logger LOGGER = LoggerFactory.getLogger(SpeicherDBClient.class);

  @GuardedBy("SpeicherDBClient.class") private static Path rocksDbDir = null;
  @GuardedBy("SpeicherDBClient.class") private static Path optionsFile = null;
  @GuardedBy("SpeicherDBClient.class") private static RocksObject dbOptions = null;
  @GuardedBy("SpeicherDBClient.class") private static RocksDB rocksDb = null;
  @GuardedBy("SpeicherDBClient.class") private static int references = 0;
  ...
  public void init() throws DBException {
   synchronized(SpeicherDBClient.class) {
      if(rocksDb == null) {
   ...
   *
   * Should only be called with a {@code synchronized(SpeicherDBClient.class)` block}.
   *
